...
from PithonMusic.utils.database import get_authuser_names, get_cmode
from PithonMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from PithonMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Pithon.stop_stream(message.chat.id)
    except:
        pass
